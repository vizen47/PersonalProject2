...
namespace AmplifyBloom
{
	...
	public class AmplifyLensFlare : IAmplifyItem
	{
		...
		[SerializeField] private Vector4 m_lensFlareGhostsParams = new Vector4( 0.8f, 0.228f, 1f, 4f );// x: Intensity, y: Dispersal, z: Power Factor, w: Power Falloff
		[SerializeField] private float m_lensFlareGhostChrDistortion = 2;
		[SerializeField] private Gradient m_lensGradient;
		[SerializeField] private Texture2D m_lensFlareGradTexture;
		[SerializeField] private Vector4 m_lensFlareHaloParams = new Vector4( 0.1f, 0.573f, 1f, 128f ); // x: Intensity, y: Width, z: Power Factor, w: Power Falloff
		...
		public float OverallIntensity
		{
			...
			set
			{
				m_overallIntensity = Mathf.Max( 0f, value );
		...
		public int LensFlareGhostAmount
		{
			...
			set => m_lensFlareGhostAmount = Mathf.Clamp( value, 0, AmplifyBloom.MaxGhosts );
		}
		...
		public float LensFlareNormalizedGhostsIntensity
		{
			...
			set
			{
				m_normalizedGhostIntensity = Mathf.Max( 0f, value );
		...
		public float LensFlareGhostsIntensity
		{
			...
			set => m_lensFlareGhostsParams.x = Mathf.Max( 0f, value );
		}
		...
		public float LensFlareNormalizedHaloIntensity
		{
			...
			set
			{
				m_normalizedHaloIntensity = Mathf.Max( 0f, value );
		...
		public float LensFlareHaloIntensity
		{
			...
			set => m_lensFlareHaloParams.x = Mathf.Max( 0f, value );
		}
		...
		public int LensFlareGaussianBlurAmount
		{
			...
			set => m_lensFlareGaussianBlurAmount = Mathf.Clamp( value, 0, AmplifyBloom.MaxGaussian );
		}
	}
}
