...
namespace AmplifyBloom
{
	...
	{
		public static readonly string PrefStartUp = "ABLastSession" + Application.productName;
		public static readonly string PrefForceUpdate = "ABForceUpdate" + Application.productName;
	}

	public class StartScreen : EditorWindow
	{
		[MenuItem( "Window/Amplify Bloom/Start Screen", false, 19 )]
		public static void Init()
		{
			StartScreen window = (StartScreen)GetWindow( typeof( StartScreen ), true, "Amplify Bloom - Start Screen" );
		...
		private static readonly GUIContent TitleSTR = new GUIContent( "Amplify Bloom" );
